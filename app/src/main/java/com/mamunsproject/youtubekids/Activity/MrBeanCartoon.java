...
public class MrBeanCartoon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mr_bean_cartoon);
        ...
        DocumentReference documentReference=firebaseFirestore.
                collection("AllPlayListKEY").document("MR_BEAN_ID")
                ;
        ...
        documentReference
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if (documentSnapshot.exists()){
                    ...
                    String key=documentSnapshot.getString("MR_BEAN_ID");
        ...
        RecyclerView recyclerView =findViewById(R.id.mrBeanRecyclerviewID);
